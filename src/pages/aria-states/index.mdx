...
import Png from './egghead-cat.png'
...
<CallToAction
  {...{
    link:
      'https://egghead.io/lessons/aria-add-aria-expanded-to-add-semantic-value-and-styling',
    body:
      "I've created a 5 minute series where I apply all that you learned in this blog post.",
    linkText: 'Go To My Free Egghead Lesson',
