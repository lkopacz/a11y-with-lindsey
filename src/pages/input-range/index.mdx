...
![In Chrome, unstyled, round, light grey thumb, with a dark grey rectangular track.](./with-background-chrome.png)

In Firefox:

![In Firefox, unstyled, round, light grey thumb, with a dark grey rectangular track.](./firefox-new.png)

In Edge:

![In Edge, unstyled, square, black thumb, with a dark grey rectangular track.](./edge.png)

In IE11:

![In IE11, unstyled, square, black thumb, with a dark grey rectangular track.](./IE-11-new.png)
