...
const About = ({data}) => (
  <div>
    <Helmet 
      title="Privacy Policy | a11y with Lindsey" 
      meta={[
        {
          name: "description",
          content: "a11y with Lindsey Privacy Policy"
        }
      ]}  
      />
    <div className="wrapper">
      ...
      <div className="content">
        <main>
          ...
          <p>a11y with Lindsey ("us", "we", or "our") operates the https://www.a11ywithlindsey.com/ website 
          (the "Service").</p>
          ...
          Our Privacy Policy  for a11y with Lindsey is managed through <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">Free 
          Privacy Policy</a>.</p>
          ...
          Terms and Conditions, accessible from https://www.a11ywithlindsey.com/</p>
          ...
          <p>a11y with Lindsey uses the collected data for various purposes:</p>    
          <ul>
          ...
          <p>If you are located outside United States and choose to provide information to us, please note that 
          ...
          <p>a11y with Lindsey will take all steps reasonably necessary to ensure that your data is treated 
          ...
          <p>a11y with Lindsey may disclose your Personal Data in the good faith belief that such action 
          is necessary to:</p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of a11y with Lindsey</li>
          ...
          <ul>
            <li>
              ...
              Terms web page: <a href="https://policies.google.com/privacy?hl=en">https://policies.google.com/privacy?hl=en</a></p>
            </li>
          </ul>
          ...
          <p>If you have any questions about this Privacy Policy, please contact us by email: hello@a11ywithlindsey.com</p>
        </main>
      </div>
    </div>
  </div>
