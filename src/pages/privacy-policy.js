    ...
    <div className="wrapper">
      ...
      <div className="content">
        <main>
          ...
          <p>
            a11y with Lindsey ("us", "we", or "our") operates the
            https://www.a11ywithlindsey.com/ website (the "Service").
          </p>
          ...
          <p>
            ...
            a11y with Lindsey is managed through{' '}
          ...
          <p>
            a11y with Lindsey will take all steps reasonably necessary to ensure
          ...
          <p>
            a11y with Lindsey may disclose your Personal Data in the good faith
            belief that such action is necessary to:
          </p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>
              To protect and defend the rights or property of a11y with Lindsey
            </li>
            <li>
